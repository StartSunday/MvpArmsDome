...
import com.sun.component.commonsdk.constant.TimeConstants;
...
public final class TimeUtils {
    ...
    private static final int IS_YESTERDAY = -1;
    ...
    public static final String FORMAT1 = "yyyyMMdd-HHmmss";// 格式：年月日 小时分钟秒
    public static final String FORMAT2 = "yyyy-MM-dd-HH:mm";
    public static final String FORMAT3 = "yyyy年MM月dd日";
    public static final String FORMAT4 = "yy年M月d日";
    public static final String FORMAT5 = "yy/M/d";
    public static final String FORMAT6 = "yyyy年MM月dd日 HH:mm:ss";
    public static final String FORMAT7 = "yyyy年MM月dd日 HH点mm分";
    public static final String FORMAT8 = "MM月dd日 HH:mm:ss";
    public static final String FORMAT9 = "yy-MM-dd HH:mm:ss";
    public static final String FORMAT10 = "yyMMdd";
    public static final String FORMAT11 = "yyyy-MM-dd-HH-mm-ss";
    public static final String FORMAT12 = "yyyy-MM-dd-HH-mm-ss";
    public static final String FORMAT13 = "yyyy-MM-dd";// 格式：年－月－日
    public static final String FORMAT14 = "yyyy/MM/dd";
    public static final String FORMAT15 = "MM-dd";// 格式：月－日
    public static final String FORMAT16 = "M月d日";// 格式：xx月xx日
    public static final String FORMAT17 = "MM月dd日";
    public static final String FORMAT18 = "HH:mm:ss";// 格式：小时：分钟：秒
    public static final String FORMAT19 = "HH:mm";// 格式：小时：分钟
    public static final String FORMAT20 = "yyyy-MM";//格式：年-月
    public static final String FORMAT21 = "yyyy-MM-dd HH:mm:ss"; // 格式：年－月－日 小时：分钟：秒
    public static final String FORMAT22 = "yyyy-MM-dd HH:mm";// 格式：年－月－日 小时：分钟
    public static final String FORMAT23 = "yyyy.MM.dd HH:mm:ss";
    public static final String FORMAT24 = "yyyy.MM.dd HH:mm";
    public static final String FORMAT25 = "[MM-dd]";
    // 年的加减
     ...
     * @return 时间字符串
     */
    public static String millis2String(Date date, String format) {
    ...
    public static String getNowString(String pattern) {
        return millis2String(System.currentTimeMillis(), new SimpleDateFormat(pattern, Locale.getDefault()));
    }
...
//            DateLocal.set(new SimpleDateFormat("yyyy.MM.dd", Locale.CHINA));
    ...
    public static Date endTime(Date date) {
        SimpleDateFormat format = new SimpleDateFormat(FORMAT21, Locale.CHINA);
        try {
            date = format.parse(millis2String(date, FORMAT13) + " 24:00:00");
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return date;
     ...
     * @param creatTime
     */
    public static String setDefenceDuration(long creatTime) {
        if (0 == creatTime) {
            return "0小时";
        }
        long currentTimeMillis = System.currentTimeMillis();
        long ms = currentTimeMillis - creatTime;
        int ss = 1000;
        int mi = ss * 60;
        int hh = mi * 60;
        int dd = hh * 24;
...
//        long day = ms / dd;
     ...
     * @return 时间戳 单位:秒
     */
    public static long getSomeDayBegin(long timestamp) {
    ...
    /**
     * 获取某一个时间的当天的23点59分59秒的时间戳
     *
     * @param timestamp 时间戳
     * @return 时间戳  单位:秒
     */
    public static long getSomeDayEnd(long timestamp) {
        Calendar cl = Calendar.getInstance();
        cl.setTimeInMillis(timestamp * 1000);
    ...
    /**
     * 获取当前时间的前一天的0点0分0秒的时间戳
     *
     * @param preDay 前多少天  正数表示前几天,负数表示未来几天
     * @return 时间戳  单位:秒
     */
    public static long getPreDayBegin(int preDay) {
        Calendar cl = Calendar.getInstance();
        cl.set(Calendar.DAY_OF_MONTH, cl.get(Calendar.DAY_OF_MONTH) - preDay);
        cl.set(Calendar.HOUR_OF_DAY, 0);
        cl.set(Calendar.MINUTE, 0);
        cl.set(Calendar.SECOND, 0);
        return cl.getTimeInMillis() / 1000;
    ...
    /**
     * 获取当前时间的前一天的23点59分59秒的时间戳
     *
     * @param preDay 前多少天  正数表示前几天,负数表示未来几天
     * @return 时间戳  单位:秒
     */
    public static long getPreDayEnd(int preDay) {
        Calendar cl = Calendar.getInstance();
        cl.set(Calendar.DAY_OF_MONTH, cl.get(Calendar.DAY_OF_MONTH) - preDay);
        cl.set(Calendar.HOUR_OF_DAY, 23);
        cl.set(Calendar.MINUTE, 59);
